...
zparser.Settings = Caffeine.Interface.Category:New("ZygorRotations")
zparser.Settings:AddSubsection("ZygorRotations")

zparser.Hotbar = Caffeine.Interface.Hotbar:New({
    name = "Zygor Parser",
    options = zparser.Settings,
    buttonCount = 1,
})

zparser.Hotbar:AddButton({
    name = "Toggle",
